      ...
      {loading && (
        ...
        >
          ...
          <motion.h1
            ...
            className="font-gt-america mt-[18px] max-w-[520px] text-[28px] font-[500] leading-[30px] tracking-[-5px] text-white sm:text-[34px] sm:leading-[36px] lg:text-[40px] lg:leading-[42px]"
          >
